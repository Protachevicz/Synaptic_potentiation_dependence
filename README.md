...
Compile and run using: bash compilar_rodar.sh
Join the parallelized files using `join_files.bash`.
To plot Fig. 4 use 'gnuplot fig4.plt'
Simulation and data of Fig.5 is avaliable in file 'Fig5'
To plot Fig. 6 use 'python3 fig5.py'

---------------- FINAL NOTE -------------------
Additional questions and data can be addressed to protachevicz@gmail.com.
